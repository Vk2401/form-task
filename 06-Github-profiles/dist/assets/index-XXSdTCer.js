(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const l of e)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(e){const l={};return e.integrity&&(l.integrity=e.integrity),e.referrerPolicy&&(l.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?l.credentials="include":e.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(e){if(e.ep)return;e.ep=!0;const l=t(e);fetch(e.href,l)}})();const i=["Vk2401","sharif-22","mshajid","yrd369","mushkir","esakki2104prsnl","suriyamassmsd","riyaz1000","hema-venkat3","dineshdevelope","swethadsalvatore","vedhatech002","danielace1","kishorekumar-kp","jeya-rosini","bearcin46","muthukumarimoorthi","gayathrihg","muthuakalya"];function c(){const s=document.getElementById("cardContainer");i.forEach(r=>{fetch(`https://api.github.com/users/${r}`).then(t=>t.json()).then(t=>{const o=document.createElement("div");o.classList.add("w-72","bg-white","bg-opacity-10","shadow-md","rounded-xl","duration-500","hover:scale-105","hover:shadow-xl","m-4"),o.innerHTML=`
                    <a href="#">
                        <div class="p-2 px-5">
                            <img src="${t.avatar_url}" alt="Profile Image" class="h-auto w-72 object-cover rounded-full p-4 border-[5px] border-violet-400" id="profile-img"/>
                        </div>
                        <div class="px-4 py-3 w-72">
                            <p class="text-lg font-bold text-white truncate block capitalize text-center" id="profName">${t.name||"N/A"}</p>
                            <div class="flex items-center flex-col justify-center">
                                <div class="flex items-center bg-black bg-opacity-50 px-10 py-2 mt-2 rounded-lg justify-center gap-2">
                                    ...
                                    <span class="text-lg font-bold text-white" id="followersCount">${t.followers}</span>
                                </div>
                                <div class="flex items-center bg-black bg-opacity-50 px-10 py-2 mt-2 rounded-lg justify-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="text-violet-400" viewBox="0 0 24 24">
                                    ...
                                    <span class="text-lg font-bold text-white" id="repoCount">${t.public_repos}</span>
                                </div>
                                <a href="${t.html_url}" target="_blank" class="px-4 py-2 bg-violet-500 hover:bg-violet-700 text-white font-bold rounded-lg mt-8">View Profile</a>
                            </div>
                        </div>
                    </a>
                `,s.appendChild(o)}).catch(t=>{console.error(`Error fetching data for ${r}:`,t)})})}c();
